...
// КОРАБЛЬ (OBJ + MTL) - ОПУСТИЛ ЕЩЁ НА СТОЛЬКО ЖЕ
// ============================================================
...
function setupShip(object) {
  ...
  // 🎯 ОПУСТИЛ ЕЩЁ НА СТОЛЬКО ЖЕ (было 0.31, стало 0.34)
  shipContainer.position.set(0, -shipHeight * 0.34, 0);
  ...
  console.log(`📏 Коэффициент опускания: 0.34`);
